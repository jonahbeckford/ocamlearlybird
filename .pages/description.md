...
Performance was measured on GitHub Actions runners with dk <!--VER:dk-->2.4.3.20<!--/VER:dk--> and opam 2.5.2 (`.github/workflows/measure-performance.yml`). The right column is the `dk1-quick-setup` branch's Quick Setup number for the same step:
...
- `.github/workflows/distribute-1.3.yml`: the build matrix (5 `distribute` slots and `combine`), dk engine `<!--VER:dk-->2.4.3.20<!--/VER:dk-->`, `trust-packages: CommonsLang_OCaml CommonsBase_FileMagic`
